...
Message Hash: 53c830eb521b91d49f153b81b46e0e7fd6d3296d9cdfc775779da1daf9f97aec<br>
Message ID: \<CA+9ZPKqo4jX1Do9HDnLpVVNNwERe5D+OPu9kzV9RA74TPYhMOw@mail.gmail.com\><br>
Reply To: \<mailman.97921.1356076239.2176.grase-hotspot@lists.sourceforge.net\><br>
UTC Datetime: 2012-12-21 13:39:23 UTC<br>
Raw Date: Fri, 21 Dec 2012 15:39:23 -0500<br>
...
router but same problem with same configuration and a different router...
if i do the configuration using router with dhcp disable connected to a
regular wired router, then the repeater has no problem. So i do not know
exactl y what is causing this.. I guess is something in the hotspot.. but i
can't think of what. Because, in order for DHCP to give ip address it
should be able to get the mac address of the client, right?... also i See
under status that the tun0 virtual interface does not have a mac addresss,
I do not know if this has something to do with my problem..

Anyway will keep trying and see what else i can troubleshoot. .if anyone
knows anything else, would be great.
...
>
> Does anyone in the List know this?.. I believe is because i'm using the
...
> To: gr***t@lists.sourceforge.net
> Message-ID:
>         <CA+9ZPKokT4gAvSKj+He6yagSCGjj=
> 75***Q@mail.gmail.com>
> Content-Type: text/plain; charset="iso-8859-1"
>
> I just did the same configuration with a wireless router as access point
...
>         Release coming soon!)
> To: gr***t@lists.sourceforge.net
> Message-ID: <8C***3@webmail-m171.sysops.aol.com>
> Content-Type: text/plain; charset="utf-8"
>
> Hi Tim,
>
...
> Betreff: [GRASE-Hotspot] 3.7.7.2 PLEASE TEST (Was Re: 3.7.7 Release coming
> soon!)
>
>
> 3.7.7.2 is in dev this morning. More minor fixes.
...
+ _Unknown thread root_
  + 2012-12-21 (Fri, 21 Dec 2012 15:39:23 -0500) - Re: [GRASE-Hotspot] Grase-hotspot Digest, Vol 19, Issue 5 - _Santiago Berniz \<sb***z@gmail.com\>_
