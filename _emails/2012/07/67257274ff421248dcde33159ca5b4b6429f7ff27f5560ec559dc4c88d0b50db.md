...
Message Hash: 67257274ff421248dcde33159ca5b4b6429f7ff27f5560ec559dc4c88d0b50db<br>
Message ID: \<CAFaSQocq0xmakHMx=Zh9oifrYh4AXV3G+aYP81frfjRwEeWAGg@mail.gmail.com\><br>
Reply To: \<30712003.448841340273952845.JavaMail.defaultUser@defaultHost\><br>
UTC Datetime: 2012-07-13 04:13:41 UTC<br>
Raw Date: Fri, 13 Jul 2012 18:13:41 +0700<br>
...
I also have the same problem. I installed the dev.packages on top a Ubuntu
server. During the OS install my wan interface was eth1 and it was dhcp.
After I finished installing the grase dev packages, my LAN laptop couldn't
get to the grase server because it didn't hand out any ip adress. I then
edited the udev file in /etc/udev/70.persistent.net.rules to change from
eth0 to eth1 and eth1 to eth0. I think that grase 'seemed' to like the wan
if to be eth0. Next, I edited /etc/network/interfaces and changed eth1 to
eth0. After reboot, grase server did hand out the ip address alright.

Logging to the admin interface was fine. The problem started when I logged
into the captive portal as a client and got disconnected every 5 minutes.
Grase server syslog showed that coovachilli restarted itself every five
minutes. Looks like an overactive crond.

Anyway, I don't have the test grase machine with me at the moment but I
will send the syslog later and is there anything else that will help before
I do a clean install of Ubuntu server OS and then grase again.

BB

On Thu, Jun 21, 2012 at 5:19 PM, lu***e@inwind.it <lu***e@inwind.it> wrote:
...
+ 2012-06-21 (Thu, 21 Jun 2012 10:28:13 -0000) - [[GRASE-Hotspot] R: Grase hotspot session-timeout](/archive/2012/06/acc18ae635621e126f07c15983515b6f5e43b5c7049a53d00fa058133be6ffb5) - _"lucape@inwind.it" \<lu***e@inwind.it\>_
  + 2012-07-13 (Fri, 13 Jul 2012 18:13:41 +0700) - Re: [GRASE-Hotspot] R: Grase hotspot session-timeout - _bb gate \<ma***e@gmail.com\>_
