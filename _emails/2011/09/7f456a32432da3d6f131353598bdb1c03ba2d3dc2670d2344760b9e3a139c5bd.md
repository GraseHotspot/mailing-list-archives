...
layout: default
title: >
    2011-09-13 - Re: [GRASE-Hotspot] Translate Project 3.5 - Spanish
---
...
Message Hash: 7f456a32432da3d6f131353598bdb1c03ba2d3dc2670d2344760b9e3a139c5bd<br>
Message ID: \<4E6FEC5F.6040908@gmail.com\><br>
Reply To: \<SNT107-W508C828B6D870713F71199B1050@phx.gbl\><br>
UTC Datetime: 2011-09-13 16:50:55 UTC<br>
Raw Date: Wed, 14 Sep 2011 09:50:55 +1000<br>

## Raw message

```
{% raw  %}I assume when you say you lost the translations, that means you edited 
the template files?

GRASE has full support for translations, see 
http://grasehotspot.org/development/translations/ for how to get started.
The file you'll need is at 
http://trac.grasehotspot.org/browser/files/usr/share/grase/locale/English/LC_MESSAGES/grase.pot 
(there is a link at the bottom to download it), then use the normal 
gettext tools (I use poedit) to translate the strings. You'll end up 
with a grase.po file (the .pot file is used to update the .po file with 
new strings) which you have translated into Spanish. I'll then merge 
that in, and users can select spanish by changing the correct locale in 
the settings page.

Regarding the documents on the web, I'll look at getting a plugin for 
wordpress that allows us to manage multiple languages, then will give 
you an account so you can edit them.

Thanks heaps!

Tim

On 14/09/11 08:43, Maguila . wrote:
> Hi Tim!
>
> I would like to collaborate contributing the translation in Spanish.
>
> I can do it in my servant, but I would like that you were adding it to 
> the project.
>
> Might you say to me which are the principal files that you need that 
> translates?
>
> Also I am ready to translate the documents that are in the web about 
> the installation of the server and the package.
>
> Thanks and Regards
>
>
...
+ 2011-09-12 (Tue, 13 Sep 2011 05:40:29 +0200) - [[GRASE-Hotspot]  Calls for testing 3.5](/archive/2011/09/52c85867cb56f0732754e6b2841d213f349fe1229ffbbe943c3d94a24cfe5c08) - _"Maguila ." \<mi***a@hotmail.com\>_
  ...
  + 2011-09-13 (Wed, 14 Sep 2011 00:25:31 +0200) - [[GRASE-Hotspot]  Calls for testing 3.5](/archive/2011/09/eb58a366f6b5daa4e1e5876d2df3117f746d0200f78b2475e6d7393ef7c840e3) - _"Maguila ." \<mi***a@hotmail.com\>_
    + 2011-09-13 (Wed, 14 Sep 2011 00:43:49 +0200) - [[GRASE-Hotspot]  Translate Project 3.5 - Spanish](/archive/2011/09/f7e6b1cea7072d33890a2aa2076eef95b54115435a5d5f7ef01f7cec6ca1c928) - _"Maguila ." \<mi***a@hotmail.com\>_
      + 2011-09-13 (Wed, 14 Sep 2011 09:50:55 +1000) - Re: [GRASE-Hotspot] Translate Project 3.5 - Spanish - _Tim White \<ti***8@gmail.com\>_
