...
Message Hash: 914e8ff8680b1f87b6d1a5bb5c03fc5bee0ddb5544853fcef8790d5affbd8008<br>
Message ID: \<de9c4647-f626-4a7e-821e-c3de00cad8d5@grasehotspot.org\><br>
Reply To: _N/A_<br>
UTC Datetime: 2017-03-16 03:52:47 UTC<br>
Raw Date: Thu, 16 Mar 2017 03:52:47 -0700<br>

## Raw message

```
{% raw  %}I know this is probably a simple issue but i must ask it anyway :

When i am on any device logged in to my network and i type in the servers 
ip address (http://10.1.0.1) it takes me to the default apache landing page 
instead of the grase login screen (http://10.1.0.1/grase/uam) what do i 
need to do to get the apache to forward the user to the correct page?
{% endraw %}
```
...
+ 2017-03-16 (Thu, 16 Mar 2017 03:52:47 -0700) - webpage login - _Daniel Crusoe \<di***n@gmail.com\>_
