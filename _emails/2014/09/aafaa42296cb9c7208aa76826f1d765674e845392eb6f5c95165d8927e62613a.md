...
Message Hash: aafaa42296cb9c7208aa76826f1d765674e845392eb6f5c95165d8927e62613a<br>
Message ID: \<CAL7r4-W=PxZYvo49GwaxNGzqDVFF09jeVvUJ36x5epNVZWyrSA@mail.gmail.com\><br>
Reply To: \<CAESLx0LTk4Xc=5cYede9RYc=bjqbt58pVNhJgKvVE+owTaA68A@mail.gmail.com\><br>
UTC Datetime: 2014-09-05 22:13:59 UTC<br>
Raw Date: Sat, 06 Sep 2014 09:43:59 +0430<br>

## Raw message

```
{% raw  %}I tried everything from the beginning and yes i was able to see groups and
creating new groups was fine. But I'm not able to login on the client side.
It says: "login failed due to sever error. Please try again". What should i
do? where can i see the log files?
Thanks tim
On Sep 6, 2014 8:56 AM, "Timothy White" <ti***8@gmail.com> wrote:

>
> On Mon, Sep 1, 2014 at 5:28 PM, Mohammad Javad <pe***t@gmail.com>
> wrote:
>
>> Hi Tim. Thanks for the support. Yes i tried what you explained and it
>> solved the problem. The apache service runs without any error and i can get
>> access to admin and login portal. Love your login page. It looks great. I'm
>> now having another problem. When i go to the group page to create a new
>> group, i can't see the predefined groups and when i try to create a new
>> group, nothing happens. I looked at radmin database and groups table was
>> empty. Then i tried to copy some data from the stable release database and
>> i was able to see the groups. I noticed there are some changes to the
>> nightly database schema. I tried creating a user with Visitors group and it
>> created the username and password but when i tried logging in it gave me
>> this error "login failed due to server error". Then I removed radius and
>> radmin database and replaced it with the stable release database and all of
>> its data and everything seems to be working all right. Once again great
>> project.
>>
>
> The groups should be fixed in a nightly I'm uploading now.
>
> Regards
>
> Tim
...
> https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/CAESLx0LTk4Xc%3D5cYede9RYc%3Dbjqbt58pVNhJgKvVE%2BowTaA68A%40mail.gmail.com
> <https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/CAESLx0LTk4Xc%3D5cYede9RYc%3Dbjqbt58pVNhJgKvVE%2BowTaA68A%40mail.gmail.com?utm_medium=email&utm_source=footer>
> .
>
{% endraw %}
```
    ...
    + 2014-08-31 (Mon, 01 Sep 2014 08:08:24 +1000) - [Re: [GRASE-Hotspot] Re: Nightly Build](/archive/2014/08/11f8a9a770da558a3970b062ff5a6a0434527b13da82da72303408d54c7c5402) - _Timothy White \<ti***8@gmail.com\>_
      ...
      + 2014-09-01 (Mon, 01 Sep 2014 11:58:05 +0430) - [Re: [GRASE-Hotspot] Re: Nightly Build](/archive/2014/09/8e3b22b2973faceb96744f92fe5f33850ae7075b6c0e10a647ab0c4388978210) - _Mohammad Javad \<pe***t@gmail.com\>_
        ...
        + 2014-09-05 (Sat, 06 Sep 2014 14:26:54 +1000) - [Re: [GRASE-Hotspot] Re: Nightly Build](/archive/2014/09/a3b22dfb5bc9c7032ccccb03a33713207ce53743eae4f9c6fe565abbe7518c2a) - _Timothy White \<ti***8@gmail.com\>_
          ...
          + 2014-09-05 (Sat, 06 Sep 2014 09:43:59 +0430) - Re: [GRASE-Hotspot] Re: Nightly Build - _Mohammad Javad \<pe***t@gmail.com\>_
