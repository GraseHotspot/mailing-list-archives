...
layout: default
title: >
    2014-08-31 - Re: [GRASE-Hotspot] Nightly Build
---
...
Message Hash: 250c823ac31ef4fec591bb95bc7c2ac68c2a448833bcd59ad175d2e54b3b77b5<br>
Message ID: \<CAL7r4-UsKhbvdDig+5ftzmrsfErMuLeiU9-UMQrVXbNQRcLRNQ@mail.gmail.com\><br>
Reply To: \<CAESLx0LoQDfZ-zCOJA-DVPeUnrxj4aoPx=GyN_WkqMtm7SMS5A@mail.gmail.com\><br>
UTC Datetime: 2014-08-31 00:18:12 UTC<br>
Raw Date: Sun, 31 Aug 2014 11:48:12 +0430<br>

## Raw message

```
{% raw  %}Thanks for the response Tim. I appreciate it. I'm going to try this new
build on virtual machine and then I'm going to let you and the community
know about my experience. I'm now downloading Ubuntu server 14.04.1 i386
and then i will install it and follow the install instruction on your
website to install the nightly build. (That's how i was able to install the
stable version so i suppose it's pretty much the same but i just need to
edit greasehotspot.list file and then proceed with the rest of the
document. Am i right?)
I also have another question but i will open a new post for that.
Thanks Tim
On Aug 31, 2014 11:09 AM, "Timothy White" <ti***8@gmail.com> wrote:

> Hi Mohammad
>
> Yes, the nightly builds include the new mobile first login page design.
> You need to edit your grasehotspot.list file to have nightly.packages...
>
> So from
...
>
> There is no gaurantee that it'll run on anything other than Debian 7.
> You'll probably want Ubuntu 14.04 if using Ubuntu.
>
> Tim
>
>
> On Sat, Aug 30, 2014 at 3:49 PM, Mohammad Javad <pe***t@gmail.com
> > wrote:
>
>> Hello tim thanks for the amazing project. I've been testing it for about
>> a week now and it awesome. Could you explain how i can install the nightly
...
>> http://groups.google.com/a/grasehotspot.org/group/grase-hotspot/.
>> To view this discussion on the web visit
>> https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/CAL7r4-WNm3WUVKr9yQcP8ByeEdZF7_z7h7zHmE%3DV_%2BYp5JyzQA%40mail.gmail.com
>> <https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/CAL7r4-WNm3WUVKr9yQcP8ByeEdZF7_z7h7zHmE%3DV_%2BYp5JyzQA%40mail.gmail.com?utm_medium=email&utm_source=footer>
>> .
>>
>
>  --
...
> http://groups.google.com/a/grasehotspot.org/group/grase-hotspot/.
> To view this discussion on the web visit
> https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/CAESLx0LoQDfZ-zCOJA-DVPeUnrxj4aoPx%3DGyN_WkqMtm7SMS5A%40mail.gmail.com
> <https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/CAESLx0LoQDfZ-zCOJA-DVPeUnrxj4aoPx%3DGyN_WkqMtm7SMS5A%40mail.gmail.com?utm_medium=email&utm_source=footer>
> .
>
{% endraw %}
```
...
+ 2014-08-29 (Sat, 30 Aug 2014 11:15:22 +1000) - [Nightly Build](/archive/2014/08/4cf1a01995112c67231fa0e0259f0729506568e0266db2ac09055ed46fa8cadc) - _Timothy White \<ti***8@gmail.com\>_
  + 2014-08-29 (Sat, 30 Aug 2014 10:19:37 +0430) - [Re: [GRASE-Hotspot] Nightly Build](/archive/2014/08/2cd85b8572e708744f021a1741e8ec3e10acdfd928dd1389979d06bb190b96ef) - _Mohammad Javad \<pe***t@gmail.com\>_
    + 2014-08-30 (Sun, 31 Aug 2014 16:39:53 +1000) - [Re: [GRASE-Hotspot] Nightly Build](/archive/2014/08/88c71a45ffea9687e9a0d2a64e95fd249b985be321c6856ccf9d0834cf16483f) - _Timothy White \<ti***8@gmail.com\>_
      + 2014-08-31 (Sun, 31 Aug 2014 11:48:12 +0430) - Re: [GRASE-Hotspot] Nightly Build - _Mohammad Javad \<pe***t@gmail.com\>_
