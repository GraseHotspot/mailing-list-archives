...
Message Hash: 5c9d624d306266a293a4bcdfb761b5ae9d2d20b27ee5b2c8c61fb3322adf789b<br>
Message ID: \<CAESLx0KFKOC9KPiJ7vzhjps1YY=WMx9ojnoEngwfESCn2W-16A@mail.gmail.com\><br>
Reply To: \<55797BD2.30406@radez.hr\><br>
UTC Datetime: 2015-06-11 13:47:36 UTC<br>
Raw Date: Fri, 12 Jun 2015 06:47:36 +1000<br>

## Raw message

```
{% raw  %}It's actually really simple as to why only Sheena has been effected by this.
Sheena is using Ubuntu 15.04, which isn't officially supported. I support
the LTS releases, as they are a slower moving target. I don't mind people
trying newer releases, as it helps catch things that could be an issue in
the next LTS if not fixed.

Ideally, in production I recommend Debian or Ubuntu LTS, without desktop.
Which is actually a way of saying, ideally without network manager.

Sheena, if you want a running system, I recommend installing Ubuntu 14.04
at this stage, as even if dnsmasq fix the bug, it probably won't be in
Ubuntu until 15.10.
...
On Thu, Jun 11, 2015 at 10:15 PM, Dražen Žuvela <dr***a@radez.hr>
wrote:

>  11.6.2015. u 13:03, Sheena Arora je napisao/la:
>
> Hi Tim,
>
>  Thanks for your support. Really appreciate it.
>
>  However, there are a couple of things that are bugging me here. *How
> come no one else faced this issue while installing grase? *And, where can
...
> When exactly that dnsmasq change happened ?
> Will that affect running systems if ubuntu installation do regular update ?
>
> I have two systems  recently installed without a problem (even have  3rd
> one as backup). Installations passed smoothly.  Today they are all at
> version:  v3.7.7.11.404.g3f1727f
> All systems working without a problem.  Ok, they are not loaded more then
> few couples of clients but they are working. Machine (mac)  mostly.
> If someone curios: One system is set to accept authentification from WAN
> side and local dd-wrt routers as per Norberto's  instructions (Dec.2014).
> This bug shouldn't affect those remote clients at grase, but some day may
> affect them on dd-wrt router, because chilli is up there too.
>
> rgds.
> Drazen
>
...
> https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/55797BD2.30406%40radez.hr
> <https://groups.google.com/a/grasehotspot.org/d/msgid/grase-hotspot/55797BD2.30406%40radez.hr?utm_medium=email&utm_source=footer>
> .
>
{% endraw %}
```
...
+ 2015-06-03 (Wed, 03 Jun 2015 00:27:17 -0700) - [Grase nightlyBuilds connection problem](/archive/2015/06/55a20876773d800ac06e37ec6cbdd825fd24c209a9f2803aa289fbc0b462ff11) - _shaveta puri \<sh***9@gmail.com\>_
  ...
  + 2015-06-11 (Thu, 11 Jun 2015 04:03:13 -0700) - [Re: Grase nightlyBuilds connection problem](/archive/2015/06/7f8b03f1f153327de40898d12c3c4bab2ea3e26eac2f7d8d698646d511f4966c) - _Sheena Arora \<sh***2@gmail.com\>_
    + 2015-06-11 (Thu, 11 Jun 2015 14:15:14 +0200) - [Re: [GRASE-Hotspot] Re: Grase nightlyBuilds connection problem](/archive/2015/06/aee8960e22318a0f3d3e0a61f6453b2a9d6c369e9ce5b434f022b8b4be2dd2d7) - _Dražen Žuvela \<dr***a@radez.hr\>_
      + 2015-06-11 (Fri, 12 Jun 2015 06:47:36 +1000) - Re: [GRASE-Hotspot] Re: Grase nightlyBuilds connection problem - _Timothy White \<ti***8@gmail.com\>_
