...
layout: default
title: >
    2015-11-04 - New install and problems dnsmasq
---
...
Message Hash: 10c076b2a93726bb2945627806a3da21c60d496d6877fdf92d1a9e4690ecc04d<br>
Message ID: \<CACJdL0PVH2b_5L8TNHd=g3y0JJ8PRmYaZjanL+fGyx3XuS+Gyg@mail.gmail.com\><br>
Reply To: _N/A_<br>
UTC Datetime: 2015-11-04 16:16:13 UTC<br>
Raw Date: Wed, 04 Nov 2015 18:16:13 -0500<br>

## Raw message

```
{% raw  %}Hi I just did a new install on the latest Ubuntu server, all appear to work
except, in the server status I have DNS (DNSMASQ) red, and if some try to
log using any URL, the main welcome page do not show up.
...
+ 2015-11-04 (Wed, 04 Nov 2015 18:16:13 -0500) - New install and problems dnsmasq - _Jean Létourneau \<ve***t@gmail.com\>_
