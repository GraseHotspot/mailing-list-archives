...
layout: default
title: >
    2019-03-04 - Login screen not showing
---
...
Message Hash: 3deb334e6e9071fbde43d955501ec467f20776e82e09cb950584fa8da1560578<br>
Message ID: \<8824f3e8-a54e-4566-a619-da7c7e6a9282@grasehotspot.org\><br>
Reply To: _N/A_<br>
UTC Datetime: 2019-03-04 20:09:32 UTC<br>
Raw Date: Mon, 04 Mar 2019 19:09:32 -0800<br>

## Raw message

```
{% raw  %}Recently, possibly the last few months the Login page has not been showing 
although users areconnected to hotspot wifi server. The hotspot has been 
running excellently for several years now continuously except for the odd 
power outages. There was a severe electrical storm about the time of the 
failure but not sure if that has any bearing on the problem. 
Due to lack of time to investigate I gave the owner of the hotspot a 
workaround to login which worked then and when I tested again today is 
still a usable method to login.
The IP address's in my case are 192.168.2.1 or 192.168.0.1/grase/uam. It 
seems this is beyond a lot of people to enter so need to find out what I 
need to do to get the login page working again. I have tried rebooting as 
well but end up back in same place.
...
+ 2019-03-04 (Mon, 04 Mar 2019 19:09:32 -0800) - Login screen not showing - _edlinp \<pe***b@gmail.com\>_
